...
def main():
    valid_samples = np.load("../../../../output/example_unified_samples.npy")
    energy_values = np.load("../../../../output/example_unified_energy.npy")
    delF_values = np.load("../../../../output/example_unified_delF.npy")
    bias_values = np.load("../../../../output/example_unified_bias.npy")
    ...
    free_energy_est = delF_values[0,-1,:]
    free_energy_est-=np.min(free_energy_est)
    x_free_energy = np.linspace(-3, 3, 121)
    ax.plot(x_free_energy, free_energy_est, color = "red", label = "free_energy estimate")
