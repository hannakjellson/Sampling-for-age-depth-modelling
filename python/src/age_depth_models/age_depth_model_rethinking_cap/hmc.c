...
double energy_function(
    ...
    int D18O_depth_indices[num_D18O_depths], double inv_D18O_var[num_D18O_depths], double D18O_expected_ages[num_D18O_depths], const double *D18O_reference, const double *D18O_reference_times, const double *sed_rates)
{
...
double capped_energy_function(
    ...
    int num_c14_depths, int num_D18O_depths, int num_D18O_reference_times, const double *c14_ages, const double *c14_depths,
    const double *c14_sigma, int c14_depth_indices[num_c14_depths], double inv_c14_var[num_c14_depths], double c14_expected_ages[num_c14_depths], const double *D18O, const double *D18O_depths, const double *D18O_sigma,
    int D18O_depth_indices[num_D18O_depths], double inv_D18O_var[num_D18O_depths], double expected_D18O_ages[num_D18O_depths], const double *D18O_reference, const double *D18O_reference_times, const double *sed_rates, double cap_energy, double CV_point, double start_bias, double end_bias)
{
...
void grad_capped_energy_function(
    ...
    int D18O_indices[num_D18O_depths], double inv_D18O_var[num_D18O_depths], double D18O_expected_ages[num_D18O_depths], const double *D18O_reference, const double *D18O_reference_times, const double *sed_rates, double cap_energy, double gradient[N], double CV_point, double start_bias, double end_bias)
{
    // derivative of -log(p(log(sed_rates)|data)) with respect to log(sed_rates)
    double f_l;
    double c14_conditional_term;
...
void hmc(
    ...
    double a, double b, double theta, int num_c14_depths, int num_D18O_depths, int num_D18O_reference_times, double startbias, double endbias, const double *c14_ages,
    ...
    double *samples_out, double *energy_out, double *bias_out)
{
    ...
    double cap_energy = 2.775842e+01 + DeltaE;
...
#pragma omp parallel for
    for (int i = 0; i < num_chains; i++)
    {
        ...
        for (int l = 0; l < num_samples; l++)
        {
            ...
            energy_out[i * num_samples + l] = energy;
            ...
            for (int j = 0; j < num_HMC; j++)
            {
                ...
                logp_old = capped_energy_function(N, delta_c, cs, a, b, theta, num_c14_depths, num_D18O_depths, num_D18O_reference_times, c14_ages, c14_depths, c14_sigma,
                                                  c14_depth_indices, inv_c14_var, c14_expected_ages, D18O, D18O_depths, D18O_sigma, D18O_depth_indices, inv_D18O_var, D18O_expected_ages, D18O_reference, D18O_reference_times, variables, cap_energy, CV_point, startbias, endbias) +
                ...
                grad_capped_energy_function(N, delta_c, cs, a, b, theta, num_c14_depths,
                                            ...
                                            D18O_depth_indices, inv_D18O_var, D18O_expected_ages, D18O_reference, D18O_reference_times, variables, cap_energy, gradient, CV_point, startbias, endbias);
                CV_point = get_CV_point(N, theta, variables, problem_index, delta_c);
                ...
                energy = keep_variables ? logp_old : logp_new;
                if (keep_variables)
                {
                    expected_ages(N, delta_c, cs, theta, num_c14_depths, c14_depths,
                                  variables, c14_depth_indices, c14_expected_ages);
