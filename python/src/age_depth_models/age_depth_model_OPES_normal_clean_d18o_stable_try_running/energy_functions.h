...
void update_delta_F(int num_temps, double *betas, double *delta_F_nominator_sum, double *delta_F_denominator_sum, double *delta_F, double *bias_out, double *energy_out, double *df_out, int i, int j, int num_samples, double min_dfd, double *max_dfn, int stop_throw_idx);
