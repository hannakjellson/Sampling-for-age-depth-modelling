...
void update_delta_F(int num_temps, double *betas, double energy, double *delta_F_nominator_sum, double *delta_F_denominator_sum, double *delta_F_denominator_track, double *delta_F, double bias, double *df_out, int idx, int j, double dfd, double *dfn);
