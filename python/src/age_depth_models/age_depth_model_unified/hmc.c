...
void hmc(
    ...
    double a, double b, double theta, double dflim, double startbias, double endbias, double bias_distance_count, int num_c14_depths, int num_D18O_depths, int num_D18O_reference_times, const double *c14_ages,
